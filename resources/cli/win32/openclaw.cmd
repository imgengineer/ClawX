...
if /i "%1"=="update" (
    echo openclaw is managed by ClawMate ^(bundled version^).
    echo.
    echo To update openclaw, update ClawMate:
    echo   Open ClawMate ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=ClawMate
"%~dp0..\..\ClawMate.exe" "%~dp0..\openclaw\openclaw.mjs" %*
